...
//Голландский аукцион 
// Устонавливаем мксимальную ставку
// Если покупатель не нашелся уменьшаем ставку
// Как только находится покупатель аукцион заканчивается 

contract AucEngine {
    address public owner; //owner of engine
    uint constant DURATION = 2 days;
    uint constant FEE = 10; //10% to engine owner
